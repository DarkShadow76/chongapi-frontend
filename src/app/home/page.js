...
const Page = () => {
  return <Container>
    <Row>
      <Col xs={12} md={6}>
        <h3>Infórmate de los mejores puntos para divertite</h3>
        <h5>Más de 100 negocios en todo la costa confían en nosotros.</h5>
      ...
      <Col xs={12} md={6} style={{ marginBottom: "5rem" }}>
        <h3>ChongAPI es tu guia para el mundo Chongueril</h3>
      ...
      <Col>
        <h6>ChongApi la mejor plataforma para brindarte información sobre tus anfitrionas</h6>
      </Col>
    </Row>
  </Container>
}
